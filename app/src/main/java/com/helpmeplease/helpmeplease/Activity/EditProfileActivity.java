...
//                "Password":"1234","MemberPhone":"0820530650","MemberSex":"ชาย"}
        ...
        // Dialog
        final AlertDialog.Builder  ad = new AlertDialog.Builder(EditProfileActivity.this);
                ...
                else if(txtPass.getText().length() == 0)
                {
                    ...
                    dialog.setPositiveButton("ยืนยัน", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            String url2 = "http://newwer.96.lt/API/EditMember.php";
                            ...
                            if (strStatusID.equals("0")) {
                                Toast.makeText(EditProfileActivity.this, strError, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(EditProfileActivity.this, strError, Toast.LENGTH_SHORT).show();
//                                txtName.setText("");
//                                txtEmail.setText("");
