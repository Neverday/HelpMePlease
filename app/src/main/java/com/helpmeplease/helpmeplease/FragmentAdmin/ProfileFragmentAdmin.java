...
import com.helpmeplease.helpmeplease.Activity.EditProfileAdminActivity;
...
public class ProfileFragmentAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_profile_fragment_admin, container, false);
        btnEdit = (Button) view.findViewById(R.id.btn_edit);
        btnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProfileFragmentAdmin.this.getActivity(), EditProfileAdminActivity.class);
                startActivity(i);
            }
        });
